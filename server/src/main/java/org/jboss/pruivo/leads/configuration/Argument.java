...
public enum Argument {
    HOST("--host", true, "127.0.0.1", "HotRod server listening host name or ip address."),
    PORT("--port", true, Integer.toString(ConfigurationProperties.DEFAULT_HOTROD_PORT), "HotRod server listening port."),
    CONFIGURATION("--configuration", true, "sample-config.xml", "Configuration file for Infinispan-"),
